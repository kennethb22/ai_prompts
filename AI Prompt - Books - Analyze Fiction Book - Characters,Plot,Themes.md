...
4. **H2 Headers:** The three major sections of the report **must** be formatted as level 2 markdown headers (`## I. Dramatis Personae`, `## II. Detailed Plot Summary by Chapter`, and `## III. Primary Themes`).
...
Compose a comprehensive summary of the plot, organizing the summary by chapter from beginning to end. This summary should be detailed enough to track the main narrative arc and key subplots.
...
- Describe Scenes: Briefly describe the setting and context of pivotal moments.
    
- Note Locations: Mention the primary locations where the story unfolds and specify when the action moves between them.
    
    Example Format:
    
    Chapter 1: [Summary of events, characters, and locations in Chapter 1.]
    
    Chapter 2: [Summary of events, characters, and locations in Chapter 2.]
...
Identify and describe the primary themes found in the work. For each theme, provide a brief explanation of how it is developed in the story, using examples from the plot or characters if possible.

Example Format:

[Theme 1, e.g., "Love and Loss"]: [Brief explanation of how this theme is explored in the book.]

[Theme 2, e.g., "Social Justice"]: [Brief explanation of how this theme is explored in the book.]
